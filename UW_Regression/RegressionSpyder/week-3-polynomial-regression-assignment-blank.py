...
set1, set2 = half1.random_split(0.5, seed=0)
set3, set4 = half2.random_split(0.5, seed=0)

# Fit a 15th degree polynomial on set_1, set_2, set_3, and set_4 using sqft_living to predict prices. Print the coefficients and make a plot of the resulting model.

# In[ ]:

def fit_print_plot(ds, degree):
...
# In[ ]:
fit_print_plot(set1, 15)


# In[ ]:
fit_print_plot(set2, 15)


# In[ ]:
fit_print_plot(set3, 15)


# In[ ]:
fit_print_plot(set4, 15)
...
def fit_rss(train, valid, degree):
    ...
    predictions = model.predict(polynomial_sframe(valid['sqft_living'], degree))
    
    rss = sum(pow(valid['price']-predictions, 2))
...
fit_rss(training, validation, 2)

degrees = graphlab.SArray(range(1,15+1))
errors = degrees.apply(lambda d: fit_rss(training, validation, d))
...
fit_rss(training, test, errors.argmin() + 1)
